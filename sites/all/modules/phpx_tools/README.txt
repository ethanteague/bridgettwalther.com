...
future.
I often used the PHP Execute feature to quick test some code and it happend 
oftenn that after an error the page reloaded but the code I ran was gone so 
